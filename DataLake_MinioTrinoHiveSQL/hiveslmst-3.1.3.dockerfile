...
RUN curl -L https://repo1.maven.org/maven2/org/apache/hive/hive-standalone-metastore/${METASTORE_VERSION}/hive-standalone-metastore-${METASTORE_VERSION}-bin.tar.gz | tar zxf - && \    
    ...
    curl -L --output aws-java-sdk-bundle-${aws-sdk-bundle}.jar https://repo1.maven.org/maven2/com/amazonaws/aws-java-sdk-bundle/${aws-sdk-bundle}/aws-java-sdk-bundle-${aws-sdk-bundle}.jar && \
    ...
    # Replacing the aws-sdk-bundle to the latest one
    cp aws-java-sdk-bundle-${aws-sdk-bundle}.jar ${HADOOP_HOME}/share/hadoop/tools/lib/ && \
...
# docker build . --tag smartydarren/hive-standalonemetastore:3.1.3 -f ./hiveslmst-3.1.3.dockerfile --no-cache
